...
class FAABasedQueueSimplified<E> : Queue<E> {
    private val infiniteArray = AtomicReferenceArray<Any?>(10) // conceptually infinite array
    private val enqIdx = AtomicLong(0)
    private val deqIdx = AtomicLong(0)

    override fun enqueue(element: E) {
        while (true) {
            val i = enqIdx.getAndIncrement() % infiniteArray.length()
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            val i = deqIdx.getAndIncrement() % infiniteArray.length()
